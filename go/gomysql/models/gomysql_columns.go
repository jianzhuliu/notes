...
func (t T_columns) ToMap() map[string]interface{} {
	...
	result["Created"] = t.Created.Format(C_time_format_layout)
...
func (t *Tobj_columns) Informaton() string {
	tmp := []string{
		...
		"\tCreated\ttime.Time\t//DbOrder:1,KindSize:24,DataType:timestamp,ColumnType:timestamp,ColumnComment:创建时间",
		"}",
	}
